...
public class MyProgreeBar extends RelativeLayout {
    ...
    public MyProgreeBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyProgreeBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        mView = inflater.inflate(R.layout.myprogressbar, this, true);
    }
    ...
    public void letuspaint(double aDouble){
        ...
        //imageView.layout(aDouble/30*(widthnow-10)+5,0,8,8);

        Double dd= (aDouble/30)*(widthnow-30);
